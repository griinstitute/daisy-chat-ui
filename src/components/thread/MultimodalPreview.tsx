    ...
    return (
      <div className={cn("relative inline-block", className)}>
        ...
        {removable && (
          <button
            type="button"
            className="absolute top-1 right-1 z-10 rounded-full bg-black/60 text-white hover:bg-black/80"
            onClick={onRemove}
    ...
    return (
      ...
      >
        ...
        {removable && (
          <button
            type="button"
            className="bg-muted hover:bg-muted ml-2 self-start rounded-full p-1 text-teal-700"
            onClick={onRemove}
  ...
  return (
    ...
    >
      ...
      {removable && (
        <button
          type="button"
          className="bg-muted text-muted-foreground hover:bg-muted ml-2 rounded-full p-1"
          onClick={onRemove}
