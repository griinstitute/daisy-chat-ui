...
export function ThreadView({ interrupt }: ThreadViewProps) {
  ...
  return (
    <div className="bg-muted flex h-full w-full flex-col rounded-2xl p-8 lg:flex-row">
      {showSidePanel ? (
        <StateView
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      idx === activeInterruptIndex
                        ...
                        : "hover:border-primary hover:text-primary border-border bg-card text-muted-foreground",
                    )}
                  >
                    {title}
                  </button>
